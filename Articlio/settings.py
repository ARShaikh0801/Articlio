...
if _cloudinary_url:
    _m = re.match(r'cloudinary://(?P<api_key>[^:]+):(?P<api_secret>[^@]+)@(?P<cloud_name>.+)', _cloudinary_url)
    if _m:
        _cloud_name = _m.group('cloud_name')
        _api_key = _m.group('api_key')
        _api_secret = _m.group('api_secret')
