...
class CSPMiddleware:
    ...
    def __call__(self, request):
        ...
        response["Content-Security-Policy"] = (
            ...
            "img-src 'self' https: data: https://*.cloudinary.com https://res.cloudinary.com; "
            "font-src 'self' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://fonts.gstatic.com; "
            "connect-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://www.google.com https://*.google.com https://*.cloudinary.com https://res.cloudinary.com https://api.cloudinary.com; "
            "media-src 'self' https://*.cloudinary.com https://res.cloudinary.com; "
